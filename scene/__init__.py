...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], ply_path=None):
        ...
        for resolution_scale in resolution_scales:
            ...
            self.trajectory_cameras[resolution_scale] = cameraList_from_camInfos(scene_info.trajectory_cameras, resolution_scale, args)
    ...
    def change_pc_indice(self, indice):
        self.gaussians.change_pc_indice(indice)

    def getTrajectoryCameras(self, scale=1.0):
        return self.trajectory_cameras[scale]
